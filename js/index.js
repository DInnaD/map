var GM = {
    ...
    initMap: function () {
        var coordinates = {lat: 49.580158, lng: 34.545727},
            popupContent = '<p class="content" style="text-color:black;"><h6>Мерщій на концерт, поспішай, зупинити біля Симфонічного Оркестру вимагай!</h6></p>'/*this.$popupContent.html()*/,
